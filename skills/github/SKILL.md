...
### 仓库结构
当前维护的 4 个核心仓库：
- **openclaw-recommended-skills** - Skill 推荐（⭐ 主仓库，每日更新，小步迭代）
- **openclaw-starter** - 场景配置（每周 3 次）
- **openclaw-workflows** - 自动化工作流（每周 2 次）
- **agent-learning-path** - Agent 学习教程（已完成，维护模式）

### 更新策略
| 仓库 | 频率 | 策略 |
|------|------|------|
| openclaw-recommended-skills | 每日 | 小步迭代，完善现有内容 |
| openclaw-starter | 每周 3 次 | 添加新场景配置 |
| openclaw-workflows | 每周 2 次 | 添加新工作流示例 |
| agent-learning-path | 维护 | 修复错误，更新链接 |
